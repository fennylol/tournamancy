...
func _on_settings_button_pressed() -> void:
   var min_port: int = clampi(MIN_PORT_BOX.text.to_int(), 0, 65534) if MIN_PORT_BOX.text else 49152
   var max_port: int = clampi(MAX_PORT_BOX.text.to_int(), min_port+1, 65535) if MAX_PORT_BOX.text else 65535
