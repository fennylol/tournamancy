...
class_name ColdBoost

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Boost_Cold)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.BOOST_COLD: Stacks }
