...
class_name NaturalResist

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Resist_Natural)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.RESIST_NATURAL: Stacks }
