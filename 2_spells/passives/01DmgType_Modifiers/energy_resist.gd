...
class_name EnergyResist

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Resist_Energy)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.RESIST_ENERGY: Stacks }
