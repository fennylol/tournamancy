...
class_name EnergyBoost

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Boost_Energy)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.BOOST_ENERGY: Stacks }
