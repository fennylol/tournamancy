...
func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Boost_Rot)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.BOOST_ROT: Stacks }
