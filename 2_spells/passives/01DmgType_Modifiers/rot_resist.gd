...
class_name RotResist

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Resist_Rot)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.RESIST_ROT: Stacks }
