...
class_name ImpactResist

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Resist_Impact)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.RESIST_IMPACT: Stacks }
