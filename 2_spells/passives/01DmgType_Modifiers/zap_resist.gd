...
class_name ZapResist

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Resist_Zap)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.RESIST_ZAP: Stacks }
