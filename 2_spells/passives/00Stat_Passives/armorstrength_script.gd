...
class_name ArmorStrengthSpell

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Armor_Strength)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.ARMOR_STRENGTH: Stacks }
