...
func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Sprint)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.SPRINT: Stacks }
