...
class_name MeleeCooldownSpell

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Melee_Cooldown)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.MELEE_COOLDOWN: Stacks }
