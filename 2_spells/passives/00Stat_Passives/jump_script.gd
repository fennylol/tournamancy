...
func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Jump)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.JUMP: Stacks }
