...
class_name MeleeDamageSpell

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Melee_Damage)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.MELEE_DAMAGE: Stacks }
