...
class_name LifestealSpell

func _init(stacks: int = 1) -> void: super(stacks, SpellData.PassiveSpellIDs.Lifesteal)

func _get_stat_contributions() -> Dictionary: return { SpellData.StatTypes.LIFESTEAL: Stacks }
